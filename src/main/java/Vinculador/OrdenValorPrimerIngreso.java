...
public class OrdenValorPrimerIngreso implements CriterioVinculador {
    ...
    private ArrayList<Integer> asignar(ArrayList<IngresoEgreso> ingresos, IngresoEgreso egreso) {
        ...
        ingresos.forEach(ingreso -> contador.set(this.sumarA(contador.get(), egreso, ingreso, response)));
    ...
    private int sumarA(int contador, IngresoEgreso egreso, IngresoEgreso ingreso, ArrayList<Integer> respuesta) {
